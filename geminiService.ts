...
export class GeminiService {
  ...
  static async chatWithBusinessAI(message: string, history: any[] = []): Promise<ChatResponse> {
    ...
    try {
      ...
      return {
        text: '⚠️ El servicio de IA está temporalmente no disponible. Verifique que su API key sea válida y tenga la API "Vertex AI" habilitada en su proyecto de Google Cloud.',
        sources: []
      };
